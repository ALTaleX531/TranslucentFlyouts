...
namespace TranslucentFlyouts
{
	...
	private:
		...
		struct CThemeMenu
		{
			static void __fastcall DrawItemBitmap(CThemeMenu* This, HWND hWnd, HDC hdc, HBITMAP hBitmap, bool fromPopupMenu, int iStateId, const RECT* lprc);
			static void __fastcall DrawItemBitmap2(CThemeMenu* This, HWND hWnd, HDC hdc, HBITMAP hBitmap, bool fromPopupMenu, bool noStretch, int iStateId, const RECT* lprc);	// Windows 11
		};
